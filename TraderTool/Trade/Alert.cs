    ...
    public partial class Alert : Form
    {
        ...
        public void Show(params object[] paramsList)
        {
            ...
            else
            {
                ...
                string afTitle = paramsList[1] != null ? paramsList[1].ToString() : "";
        ...
        protected void Show(string content, string soundPath, ShowWay showWay, int width, int height, int showInTime, int showTime, int showOutTime)
        {
            _timerRunCount = 0;
            ...
            try
            {
                sndPlayer = new SoundPlayer(soundPath);
